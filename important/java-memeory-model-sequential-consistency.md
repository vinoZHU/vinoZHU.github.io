...
![](/images/JMM/JMM-sequential-consistency-0.png)
...
![](/images/JMM/JMM-sequential-consistency-1.png)
现在我们再假设这两个线程没有做同步，下面是这个未同步程序在顺序一致性模型中的执行示意图：
![](/images/JMM/JMM-sequential-consistency-2.png)
...
![](/images/JMM/JMM-sequential-consistency-3.png)
...
![](/images/JMM/JMM-sequential-consistency-4.png)
...
![](/images/JMM/JMM-sequential-consistency-5.png)
