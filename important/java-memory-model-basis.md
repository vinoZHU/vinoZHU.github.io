...
date: 2016-05-19 08:17:16
tags: JMM
categories: JMM
photos:
- /images/JMM/JMM-common-head.jpg
---
### 并发编程模型的分类
...
| 初始状态：a = b = 0 <br> 处理器允许执行后得到结果：x = y = 0|(合并行)|

假设处理器A和处理器B按程序的顺序并行执行内存访问，最终却可能得到x = y = 0的结果。具体的原因如下图所示：
![](/images/JMM/JMM-3.png)
